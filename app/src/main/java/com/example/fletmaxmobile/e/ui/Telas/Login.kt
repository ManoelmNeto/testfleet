...
import com.example.fletmaxmobile.e.ui.viewmodel.LoginViewModel
    ...
    loginResult?.let { result ->
        if (result.isSuccess) {
            androidx.compose.runtime.LaunchedEffect(Unit) {
                navController.navigate(ScreenRoutes.DASHBOARD_SCREEN) {
                    popUpTo(ScreenRoutes.LOGIN_SCREEN) { inclusive = true } // remove login da pilha
                }
            }
        }
    }
